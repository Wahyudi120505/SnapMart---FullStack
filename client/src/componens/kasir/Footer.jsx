...
const Footer = () => {
  return (
    <motion.footer
      ...
      className="bg-slate-800/90 backdrop-blur-xl border-t border-slate-700/50 py-6 px-6 mt-auto relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto flex flex-col items-center space-y-4 relative">
        <div className="flex items-center space-x-3">
          ...
          <h2 className="text-lg font-semibold bg-gradient-to-r from-orange-400 via-red-400 to-orange-400 bg-clip-text text-transparent tracking-wide">
            SnapMart POS
          </h2>
        </div>
        ...
        <div className="flex space-x-4">
          <motion.a
            href="/about"
            whileHover={{ scale: 1.02, y: -1, color: "#f97316" }}
            whileTap={{ scale: 0.98 }}
            className="text-slate-300 hover:text-orange-400 text-sm transition-colors duration-200"
          >
            About
          </motion.a>
          <motion.a
