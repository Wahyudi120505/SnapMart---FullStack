            ...
            <div>
              ...
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none z-10">
                  <User className="h-5 w-5 text-slate-400 group-focus-within:text-orange-400 transition-colors duration-200" />
                </div>
                <input
                  type="text"
                  id="nama"
                  ...
                  className={`bg-slate-700/50 border ${
                    errors.nama ? "border-red-500" : "border-slate-600/50"
                  } text-white rounded-xl focus:ring-2 focus:ring-orange-500/50 focus:border-orange-500/50 block w-full pl-12 pr-4 py-3.5 text-sm backdrop-blur-sm transition-all duration-300 hover:bg-slate-700/70 focus:bg-slate-700/70`}
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  } text-white rounded-xl focus:ring-2 focus:ring-orange-500/50 focus:border-orange-500/50 block w-full pl-12 pr-12 py-3.5 text-sm backdrop-blur-sm transition-all duration-300 hover:bg-slate-700/70 focus:bg-slate-700/70`}
                  placeholder="••••••••••••"
                  onChange={handleInputChange}
                />
                <button
